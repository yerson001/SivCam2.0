        ...
        if md_boxes is not None:
            ...
            if total_area > self.min_area:
                if self.AI:
                    ...
                    num_relevant_objects = len(
                        [c[5] for c in boxes if c[5] == 0 or c[5] == 15 or c[5] == 16])
...
if __name__ == "__main__":
    ...
    newthread = VideoSendThread(
        container, min_area=args['area'], delay=args['delay'], camera_type=args['camera_type'])
    newthread.start()
